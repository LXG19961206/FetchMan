...
export default observer(() => {
  ...
  useEffect(() => {
    ...
    if (Object.values(reqStore.currentRequest.headers || {}).length > 0) {
      const source = Object.entries(reqStore.currentRequest.headers!)
        .map(([key, val], i) => ({
          name: key,
          value: val,
          id: i.toString()
  ...
  }, [reqStore.currentRequest.headers, reqStore.currentRequest.body])
